    ...
    <DetailLayout
      ...
      hero={
        <div style={{ display: 'flex', flexDirection: 'column', gap: space[5] }}>
          ...
          <div>
            <SectionLabel accent={color.region.kernel.fg}>The indirect call pattern</SectionLabel>
            <div
              style={{
            ...
            >
              <span style={{ color: color.region.kernel.accent }}>vfs_read</span>{' '}
              ...
              <span style={{ color: color.region.kernel.accent }}>do_sync_read</span>, which wraps
