...
export const ForkProcessDuplicationHero: React.FC = () => (
...
const ForkProcessDuplication: React.FC<DetailViewProps> = ({ node, region }) => (
  <DetailLayout node={node} region={region} heroLabel="copy_process → dup_task_struct → alloc_pid" hero={<ForkProcessDuplicationHero />} />
);
