...
const ForkReturn: React.FC<DetailViewProps> = ({ node, region }) => {
  return (
    <DetailLayout
      node={node}
      region={region}
      heroLabel="parent gets PID, child gets 0"
      hero={
...
return p->pid;   // → 1235`}</CodeBlock>
            ...
            <div style={{
              ...
              <svg width="60" height="80" viewBox="0 0 60 80">
                ...
                <line x1="30" y1="35" x2="10" y2="70" stroke={color.region.kernel.fg} strokeWidth="1.5" opacity="0.5" />
                ...
                <text x="8" y="78" fontFamily="monospace" fontSize="8" fill={color.region.kernel.fg}>parent</text>
...
# Parent's fork() returns 1235`}</CodeBlock>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                background: color.region.kernel.bg,
                border: `1px solid ${color.region.kernel.fg}55`,
                borderRadius: radius.md,
                padding: space[4],
                flex: 1,
                minWidth: '200px',
